...
Your are here at the [**optional/maximum set of requirements**](https://github.com/Money-Burned/mb-dotnet-lib/tree/main). This branch is the default - there is nothing else for you to consider.  
